...
class TestPythonOutput:
    def test_hello(self):
        code = 'print("hello")\n'
        snippet = Snippet(code, "snip-python:3.13", "")
...
class TestNumpyOutput:
    def test_elementwise_array_comparison(self):
        ...
        snippet = Snippet(code, "snip-numpy:2.5", "")
...
class TestGoOutput:
    def test_hello(self):
        ...
        snippet = Snippet(code, "snip-golang:1.25", "")
        assert snippet.output(timeout=None) == "hello\n"
...
class TestNodeOutput:
    def test_hello(self):
        ...
        snippet = Snippet(code, "snip-node:24.13", "")
        assert snippet.output(timeout=None) == "hello\n"
...
class TestRubyOutput:
    def test_hello(self):
        code = 'puts "hello"\n'
        snippet = Snippet(code, "snip-ruby:3.4", "")
        assert snippet.output(timeout=None) == "hello\n"
...
class TestRustOutput:
    def test_hello(self):
        ...
        snippet = Snippet(code, "snip-rust:1.84", "")
        assert snippet.output(timeout=None) == "hello\n"
...
class TestCOutput:
    def test_hello(self):
        ...
        snippet = Snippet(code, "snip-gcc:16.2", "")
        assert snippet.output(timeout=None) == "hello\n"
