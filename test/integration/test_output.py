...
class TestPythonOutput:
    def test_hello(self):
        code = 'print("hello")\n'
        snippet = PythonSnippet(code, "python:3.13", traceback_verbosity=0)
...
class TestGoOutput:
    def test_hello(self):
        ...
        snippet = GoSnippet(code, "golang:1.24", traceback_verbosity=0)
        assert snippet.output.raw == "hello\n"
...
class TestNodeOutput:
    def test_hello(self):
        ...
        snippet = NodeSnippet(code, "node:22", traceback_verbosity=0)
        assert snippet.output.raw == "hello\n"
...
class TestRubyOutput:
    def test_hello(self):
        code = 'puts "hello"\n'
        snippet = RubySnippet(code, "ruby:3.4", traceback_verbosity=0)
        assert snippet.output.raw == "hello\n"
...
class TestRustOutput:
    def test_hello(self):
        ...
        snippet = RustSnippet(code, "rust:1.84", traceback_verbosity=0)
        assert snippet.output.raw == "hello\n"
